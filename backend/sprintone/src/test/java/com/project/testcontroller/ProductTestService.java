...
public class ProductTestService extends OmegaApplicationTests {
    ...
    public void getAllProductsTest_Positive() throws NoRecordsFoundException {
        ...
        Product product_two = new Product.ProductBuilder()
                ...
                .setPrice(19)
                .build();
        Mockito.when(productRepository.findAll()).thenReturn(List.of(product_one, product_two));
    ...
    public void searchProductsTest() throws NoRecordsFoundException {
        ...
        Product product_two = new Product.ProductBuilder()
                ...
                .setPrice(210)
                .build();
        Mockito.when(productRepository.findByNameContaining(Mockito.anyString())).thenReturn(List.of(product_one, product_two));
    ...
    public void getProductByPrice() throws NoRecordsFoundException {
        ...
        Product product_two = new Product.ProductBuilder()
                ...
                .setPrice(210)
                .build();
        Mockito.when(productRepository.findByPrice(Mockito.anyInt())).thenReturn(List.of(product_one));
        Mockito.when(productRepository.findByPriceGreaterThanEqual(Mockito.anyInt())).thenReturn(List.of(product_one));
        Mockito.when(productRepository.findByPriceLessThanEqual(Mockito.anyInt())).thenReturn(List.of(product_two));
