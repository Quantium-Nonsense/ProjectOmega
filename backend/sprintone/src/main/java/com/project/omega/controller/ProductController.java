...
public class ProductController {
    ...
    public ResponseEntity getByUserId(@PathVariable(value = "id") Long id) throws NoRecordsFoundException, UserNotFoundException {
        List<Product> products = productService.getProductsFromUser(id);
        return new ResponseEntity(products, HttpStatus.OK);
    }
